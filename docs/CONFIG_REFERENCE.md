...
- `modes.research_mode` – light|medium|full|extreme (deep is accepted as alias for full)
...
- `allowlist.apps` – list of allowed app ids (used by optional allowlist collector)
